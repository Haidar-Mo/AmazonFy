...
return [
    ...
    'merchants' => [
        ...
        'level_change' => 'تم تغيير مستوى التاجر بنجاح',
        'visa_eligibility_toggled' => 'تم تغيير سماحية المستحدم لاستخدام خاصية التأشيرة بنجاح',
        'ticket_eligibility_toggled' => 'تم تغيير سماحية المستحدم لاستخدام خاصية الحجز بنجاح',
        'errors' => [
            ...
            'level_change' => 'حدث خطأ أثناء تغيير مستوى التاجر',
            'visa_eligibility_toggle' => 'حدث خطأ أثناء تغيير سماحية المستخدم لاستخدام خاصية التأشيرة',
            'ticket_eligibility_toggled' => 'حدث خطأ أثناء تغيير سماحية المستخدم لاستخدام خاصية الحجز',
    ...
    'wallet' => [
        ...
        'errors' => [
            ...
            'cancel_deny' => 'لا يمكن إلغاء هذه الطلبية',
            'update_deny' => 'لا يمكن تعديل حالة هذه الطلبية',
            'insufficient_funds' => 'ليس لديك رصيد كافي',
            'margin_insufficient_funds' => 'ليس لديك رصيد كافي في الهامش',
    ...
    'order' => [
        ...
        'errors' => [
            ...
            'create_error' => 'حدث خطأ أثناء إنشاء طلبك',
    ...
    'product' => [
        ...
        'add_success' => 'تم إضافة المنتج',
        'remove_success' => 'تم إزالة المنتج',
        'errors' => [
            ...
            'add_error' => 'حدث خطأ أثناء إضافة المنتج',
    ...
    'transactions' => [
        ...
        'errors' => [
            ...
            'update_deny' => 'لا يمكن معالجة هذه المعاملة',
        ],
    ],
    ...
    'visa' => [
        'index_success' => 'تم جلب التأشيرات بنجاح',
        'create_success' => 'تم إنشاء التأشيرة بنجاح',
        'update_success' => 'تم تعديل التأشيرة بنجاح',
        'delete_success' => 'تم حذف التأشيرة بنجاح',
        'errors' => [
            'index_error' => 'حدث خطأ أثناء جلب التأشيرات',
            'create_error' => 'حدث خطأ أثناء إنشاء التأشيرة',
            'update_error' => 'حدث خطأ أثناء تعديل التأشيرة',
            'delete_error' => 'حدث خطأ أثناء حذف التأشيرة',
        ],

        'request' => [
            'submission_success' => 'تم تقديم طلب التأشيرة بنجاح',
            'delete-success' => 'تم حذف طلب التأشيرة بنجاح',
            'status-success' => 'تم تغيير حالة طلب التأشيرة بنجاح',

            'errors' => [
                'submission_error' => 'حدث خطأ أثناء تقديم طلب التأشيرة',
                'delete_error' => 'حدث خطأ أثناء حذف طلب التأشيرة',
                'status_error' => 'حدث خطأ أثناء تغيير حالة طلب التأشيرة'
